...
namespace exercise_5
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                // Hodnoty jsem hardcodoval, aby nebyly vyvolane vyjimky, idalne by bylo, kdybych pro vsechny hodnoty udelal scanner ktery by nastavil vsechny hodnoty podle uzivatele.
